module.exports = function (grunt) {
  ...
  var tasks_configurations = require('./taskConfigurations');  
    
  /** project configuration */
  grunt.initConfig({
    pkg: pkg,
    curl: tasks_configurations.curl(),
    clean: tasks_configurations.clean(),
    copy: tasks_configurations.copy(),
    uglify: tasks_configurations.uglify(),
    sass: tasks_configurations.sass(),
    watch: tasks_configurations.watch()
  });
