...
// Solr url for series
export const seriesUrl = `https://discovery1.dlib.nyu.edu/solr/viewer/select?fl=*&fq=bundle:dlts_series&fq=sm_series_code:${collectionCode}&sort=ss_series_label%20asc&rows=1000&wt=json`;
// Api url
